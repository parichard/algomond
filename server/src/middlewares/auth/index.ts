...
export const authenticateToken: Middleware = async (req, res, next) => {
    ...
    jwt.verify(token, "d9bdc282cb696731d7b724aa8193eefafbb91fd96dbc961586bc940ef974158e7ed9df21bb7c8d301e414e4e2e4cbaaef17aa73ec26d6214c794bac0874d1e35", (err, decoded) => {
